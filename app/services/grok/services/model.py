...
class ModelService:
    ...
    MODELS = [
        ...
        ModelInfo(
            ...
            description="Video generation model alias for Grok Imagine Video 1.5 Preview",
            is_image=False,
            is_image_edit=False,
            is_video=True,
        ),
        ...
        ModelInfo(
            ...
            tier=Tier.SUPER,
            cost=Cost.HIGH,
            display_name="Grok Imagine Video 1.5 Preview",
            description="Video generation model",
            is_image=False,
            is_image_edit=False,
            is_video=True,
        ...
        ModelInfo(
            ...
            cost=Cost.HIGH,
            display_name="Grok Imagine Video 1.5 Preview",
            description="Video generation model dated alias",
            is_image=False,
            is_image_edit=False,
            is_video=True,
        ),
